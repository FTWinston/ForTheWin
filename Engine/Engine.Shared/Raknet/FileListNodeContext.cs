...
public class FileListNodeContext : IDisposable {
  ...
  public uint flnc_extraData {
    set {
      RakNetPINVOKE.FileListNodeContext_flnc_extraData_set(swigCPtr, value);
    } 
    get {
      uint ret = RakNetPINVOKE.FileListNodeContext_flnc_extraData_get(swigCPtr);
      return ret;
    } 
  }
