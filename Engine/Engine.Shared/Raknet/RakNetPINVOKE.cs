...
class RakNetPINVOKE {
  ...
  [DllImport("RakNet", EntryPoint="CSharp_FileListNodeContext_flnc_extraData_set")]
  public static extern void FileListNodeContext_flnc_extraData_set(HandleRef jarg1, uint jarg2);

  [DllImport("RakNet", EntryPoint="CSharp_FileListNodeContext_flnc_extraData_get")]
  public static extern uint FileListNodeContext_flnc_extraData_get(HandleRef jarg1);
